...
public:
    ...
    void Init()
    {
		...
		HBKINFOM hBkInfoM = XEle_GetBkInfoManager(m_hListView);
        ...
        XAdapterListView_Group_AddColumn(hAdapter,(XC_NAME));
        ...
        int  group1=XAdapterListView_Group_AddItemText(hAdapter,L"亚洲无码");
        int  group2=XAdapterListView_Group_AddItemText(hAdapter,L"欧美无码");
