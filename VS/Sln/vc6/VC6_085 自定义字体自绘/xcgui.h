...
/// @ingroup macroDefine
/// @{
#define  XC_SY_CAPTION             0x00000001  ///<top布局,如果指定该属性,默认为绑定标题栏元素
#define  XC_SY_BORDER              0x00000002  ///<边框,指定默认上下左右布局大小,如果没有指定,那么边框布局大小为0
#define  XC_SY_CENTER              0x00000004  ///<窗口居中
#define  XC_SY_DRAG_BORDER         0x00000008  ///<拖动窗口边框
#define  XC_SY_DRAG_WINDOW         0x00000010  ///<拖动窗口

///窗口默认样式
#define  XC_SY_DEFAULT (XC_SY_CAPTION | \
	XC_SY_BORDER | \
	XC_SY_CENTER | \
	XC_SY_DRAG_BORDER)

///模态窗口
#define  XC_SY_MODAL_WINDOW (XC_SY_CAPTION | XC_SY_CENTER |  XC_SY_BORDER)
...
/// @defgroup groupWindowLayout_pos 窗口布局位置
/// @ingroup macroDefine
/// @{
#define  XC_LAYOUT_TOP           1  ///<top
#define  XC_LAYOUT_BOTTOM        2	///<bottom
#define  XC_LAYOUT_LEFT          3	///<left
#define  XC_LAYOUT_RIGHT         4	///<right
#define  XC_LAYOUT_BODY          5	///<body
...
#define XC_WIND_TRANSPARENT_SHADOW   2 ///<阴影窗口,带透明通道,边框阴影,窗口透明或半透明,当前未启用.
...
/// @ingroup macroDefine
/// @{
#define  XC_BUTTON_TYPE_DEFAULT  0 ///<默认类型
#define  XC_BUTTON_TYPE_CHECK    1 ///<复选按钮
#define  XC_BUTTON_TYPE_RADIO    2 ///<单选按钮
#define  XC_BUTTON_TYPE_CLOSE    3 ///<窗口关闭按钮
#define  XC_BUTTON_TYPE_MIN      4 ///<窗口最小化按钮
#define  XC_BUTTON_TYPE_MAX      5 ///<窗口最大化还原按钮
...
/// @ingroup macroDefine
/// @{
#define  XC_BUTTON_STYLE_DEFAULT          0  ///<默认风格
#define  XC_BUTTON_STYLE_CHECK            1  ///<复选按钮
#define  XC_BUTTON_STYLE_RADIO            2  ///<单选按钮
#define  XC_BUTTON_STYLE_SCROLLBAR_UP     3  ///<水平滚动条,上按钮
#define  XC_BUTTON_STYLE_SCROLLBAR_DOWN   4  ///<水平滚动条,下按钮
#define  XC_BUTTON_STYLE_SCROLLBAR_LEFT   5  ///<水平滚动条,左按钮
#define  XC_BUTTON_STYLE_SCROLLBAR_RIGHT  6  ///<水平滚动条,右按钮
#define  XC_BUTTON_STYLE_SCROLLBAR_SLIDER 7  ///<滚动条,滑块
#define  XC_BUTTON_STYLE_TABBAR_BUTTON    8  ///<TabBar上的按钮
#define  XC_BUTTON_STYLE_TOOLBAR_LEFT     9  ///<ToolBar左滚动按钮
#define  XC_BUTTON_STYLE_TOOLBAR_RIGHT   10  ///<ToolBar右滚动按钮

#define  XC_BUTTON_STYLE_PANE_CLOSE     11 ///<窗格关闭按钮
#define  XC_BUTTON_STYLE_PANE_AUTOHIDE  12 ///<窗格自动隐藏按钮
#define  XC_BUTTON_STYLE_PANE_MENU      13 ///<窗格下拉菜单按钮
#define  XC_BUTTON_STYLE_PANE_DOCK_H    14 ///<框架窗口左边或右边码头上按钮
#define  XC_BUTTON_STYLE_PANE_DOCK_V    15 ///<框架窗口上边或下边码头上按钮
...
/// @ingroup macroDefine
/// @{
#define  XC_LAYOUT_SIZE_Size      0   ///<指定大小
#define  XC_LAYOUT_SIZE_Fill      1   ///<fill 填充父
#define  XC_LAYOUT_SIZE_Auto      2   ///<auto 自动大小,根据内容计算大小
#define  XC_LAYOUT_SIZE_Weight    3   ///<weight 比例,按照比例分配剩余空间
#define  XC_LAYOUT_SIZE_Disable   4   ///<disable 不使用

///@}

/// @defgroup  groupListStyle  List样式
/// @ingroup macroDefine
/// @{
#define  XC_LIST_STYLE_DRAW_LEAVE   1  ///<绘制鼠标离开状态项背景
#define  XC_LIST_STYLE_DRAW_SELECT  2  ///<绘制鼠标选择状态项背景
#define  XC_LIST_STYLE_DRAW_STAY    4  ///<绘制鼠标停留状态项项背景

/// @}

/// @defgroup  groupListBoxStyle  ListBox样式
/// @ingroup macroDefine
/// @{
#define  XC_LISTBOX_STYLE_DRAW_LEAVE   1  ///<绘制鼠标离开状态项背景
#define  XC_LISTBOX_STYLE_DRAW_SELECT  2  ///<绘制鼠标选择状态项背景
#define  XC_LISTBOX_STYLE_DRAW_STAY    4  ///<绘制鼠标停留状态项项背景

/// @}

/// @defgroup  groupTreeStyle  Tree样式
/// @ingroup macroDefine
/// @{
#define  XC_TREE_STYLE_DRAW_LEAVE   1  ///<绘制鼠标离开状态项背景
#define  XC_TREE_STYLE_DRAW_SELECT  2  ///<绘制鼠标选择状态项背景
...
#define  PGRID_EDIT_COLOR   3  ///<颜色选择元素
#define  PGRID_EDIT_FILE    4  ///<文件选择编辑框
#define  PGRID_EDIT_SET     5  ///<设置
#define  PGRID_COMBOBOX     2  ///<组合框
#define  PGRID_GROUP        6  ///<组
///@}
...
/// @brief 元素鼠标离开事件.
/// @code  int CALLBACK OnMouseLeave(BOOL *pbHandled); @endcode
...
/// @brief 富文本元素 内容改变事件,需要开启后有效,XRichEdit_EnableEvent_XE_RICHEDIT_CHANGE()
...
{
public:
	CEventBase(){ m_nEvent=XC_ERROR; m_pFunCStyle=NULL; }
	UINT     m_nEvent;      //事件类型
	void*    m_pFunCStyle;
...
{
public:
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hDraw_bPtr pMember){
		return (pThis->*pMember)((HDRAW)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_uint_uint_uint_bPtr pMember){
		return (pThis->*pMember)(hEventEle, nEvent, wParam, lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_bPtr pMember){
		return (pThis->*pMember)(pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_uint_ptPtr_bPtr pMember){
		return (pThis->*pMember)(wParam, (POINT*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_uint_ptPtr_bPtr pMember){
		return (pThis->*pMember)(hEventEle, wParam, (POINT*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_e_uint_ptPtr_bPtr pMember){
		return (pThis->*pMember)(hEle, hEventEle, wParam, (POINT*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_int_int_bPtr pMember){
		return (pThis->*pMember)((int)wParam, (int)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_int_bPtr pMember){
		return (pThis->*pMember)((int)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_uint_bPtr pMember){
		return (pThis->*pMember)(wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_uint_uint_bPtr pMember){
		return (pThis->*pMember)(wParam, lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_pListBoxItem_bPtr pMember){
		return (pThis->*pMember)((listBox_item_i*)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hDraw_pListBoxItem_bPtr pMember){
		return (pThis->*pMember)((HDRAW)wParam,(listBox_item_i*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_pListItem_bPtr pMember){
		return (pThis->*pMember)((list_item_i*)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hDraw_pListItem_bPtr pMember){
		return (pThis->*pMember)((HDRAW)wParam,(list_item_i*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hDraw_pListHeaderItem_bPtr pMember){
		return (pThis->*pMember)((HDRAW)wParam,(list_header_item_i*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_pTreeItem_bPtr pMember){
		return (pThis->*pMember)((tree_item_i*)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hDraw_pTreeItem_bPtr pMember){
		return (pThis->*pMember)((HDRAW)wParam,(tree_item_i*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_pListViewItem_bPtr pMember){
		return (pThis->*pMember)((listView_item_i*)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hDraw_pListViewItem_bPtr pMember){
		return (pThis->*pMember)((HDRAW)wParam,(listView_item_i*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_bPtr pMember){
		return (pThis->*pMember)(hEventEle, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_int_bPtr pMember){
		return (pThis->*pMember)(hEventEle, wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_hDraw_bPtr pMember){
		return (pThis->*pMember)(hEventEle, (HDRAW)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_e_uint_uint_uint_bPtr pMember){
		return (pThis->*pMember)(hEle, hEventEle, nEvent, wParam, lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_e_hDraw_bPtr pMember){
		return (pThis->*pMember)(hEle, hEventEle, (HDRAW)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_e_int_bPtr pMember){
		return (pThis->*pMember)(hEle, hEventEle, wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_e_e_bPtr pMember){
		return (pThis->*pMember)(hEle, hEventEle, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hDraw_pMenuDrawBackground_bPtr pMember){
		return (pThis->*pMember)((HDRAW)wParam,(menu_drawBackground_i*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hDraw_pMenuDrawItem_bPtr pMember){
		return (pThis->*pMember)((HDRAW)wParam,(menu_drawItem_i*)lParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hMenu_bPtr pMember){
		return (pThis->*pMember)((HMENUX)wParam, pbHandled);
	}
	BOOL  Handle(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent, T_ClassName* pThis, pFun_int_hMenu_pMenuPopupWnd_bPtr pMember){
		return (pThis->*pMember)((HMENUX)wParam, (menu_popupWnd_i*)lParam, pbHandled);
	}
};
...
private:
	...
	virtual int OnEleProc(HELE hEle, HELE hEventEle, WPARAM wParam, LPARAM lParam, BOOL *pbHandled, UINT nEvent){
		return m_EventHandle.Handle(hEle, hEventEle, wParam, lParam, pbHandled, nEvent, m_pThis, m_pMember);
	}
	virtual  void* GetThis(){ return m_pThis; }
	virtual  char* GetFunName(){ return m_name; }
};
...
XC_API void WINAPI XBtn_SetState(HELE hEle,int nState);
XC_API int  WINAPI XBtn_GetState(HELE hEle);
XC_API void WINAPI XBtn_SetStyle(HELE hEle, int  nStyle);
XC_API int  WINAPI XBtn_GetStyle(HELE hEle);
XC_API void WINAPI XBtn_SetType(HELE hEle,int type);
XC_API int  WINAPI XBtn_GetType(HELE hEle);
...
XC_API void WINAPI XBtn_SetTextAlign(HELE hEle,int flag);
...
XC_API void WINAPI XBtn_SetImageLeave(HELE hEle,HIMAGE hImage);  //鼠标离开时图片
XC_API void WINAPI XBtn_SetImageStay(HELE hEle,HIMAGE hImage);   //鼠标停留时图片
XC_API void WINAPI XBtn_SetImageDown(HELE hEle,HIMAGE hImage);   //鼠标按下时图片
XC_API void WINAPI XBtn_SetImageCheck(HELE hEle,HIMAGE hImage);  //选中时图片
XC_API void WINAPI XBtn_SetImageDisable(HELE hEle,HIMAGE hImage); //按钮禁用状态图片
...
XC_API void WINAPI XComboBox_SetImageStay(HELE hEle,HIMAGE hImage);
XC_API void WINAPI XComboBox_SetImageDown(HELE hEle,HIMAGE hImage);
XC_API int WINAPI XComboBox_GetSelectItem(HELE hEle);
...
XC_API BOOL WINAPI XEle_IsBorder(HELE hEle);
...
XC_API void WINAPI XEle_EnableBorder(HELE hEle,BOOL bEnable);
...
XC_API void WINAPI XEle_SetRectLogic(HELE hEle, RECT *pRect, BOOL bRedraw=FALSE); //逻辑模式坐标
...
XC_API void WINAPI XEle_SetBkColor(HELE hEle,COLORREF color,BYTE alpha=255); //设置背景颜色
XC_API COLORREF WINAPI XEle_GetBkColor(HELE hEle);
XC_API void  WINAPI XEle_SetBorderColor(HELE hEle, COLORREF color,BYTE alpha=255);
XC_API COLORREF WINAPI XEle_GetBorderColor(HELE hEle);
...
XC_API void WINAPI XEle_SetLayoutWidth(HELE hEle,int nFlag,int nWidth);
XC_API void WINAPI XEle_SetLayoutHeight(HELE hEle,int nFlag,int nHeight);
XC_API void WINAPI XEle_GetLayoutWidth(HELE hEle, out_ int *pFlag,out_ int *pWidth);
XC_API void WINAPI XEle_GetLayoutHeight(HELE hEle, out_ int *pFlag,out_ int *pHeight);
...
XC_API void WINAPI XEle_SetImage(HELE hEle,HIMAGE hImage);
XC_API void WINAPI XEle_EnableTransparentChannel(HELE hEle,BOOL bEnable);
XC_API int WINAPI XEle_GetTemplateListItemID(HELE hEle);  //获取当前元素所在模板实例,属于列表中哪一个项.
XC_API int WINAPI XEle_GetTemplateListItemGroupID(HELE hEle);
...
XC_API int WINAPI XImage_GetDrawType(HIMAGE hImage); //获取图片绘制类型
...
XC_API void WINAPI XLayout_SetAlignH(HXCGUI hLayout,layout_align_ nFlag);
XC_API void WINAPI XLayout_SetAlignV(HXCGUI hLayout,layout_align_ nFlag);
...
XC_API void WINAPI XLayout_SetLayoutWidth(HXCGUI hLayout,int nFlag,int nWidth);
XC_API void WINAPI XLayout_SetLayoutHeight(HXCGUI hLayout,int nFlag,int nHeight);
XC_API void WINAPI XLayout_GetLayoutWidth(HXCGUI hLayout,out_ int *pFlag,out_ int *pWidth);
XC_API void WINAPI XLayout_GetLayoutHeight(HXCGUI hLayout,out_ int *pFlag,out_ int *pHeight);
...
XC_API void WINAPI XListBox_SetStyle(HELE hEle, int style);
...
XC_API void WINAPI XListBox_SetItemColor(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API COLORREF WINAPI XListBox_GetItemColor(HELE hEle);
XC_API void WINAPI XListBox_SetItemColorSel(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API COLORREF WINAPI XListBox_GetItemColorSel(HELE hEle);
XC_API void WINAPI XListBox_SetItemColorStay(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API COLORREF WINAPI XListBox_GetItemColorStay(HELE hEle);
...
XC_API void WINAPI XList_SetStyle(HELE hEle,int style);
...
XC_API void WINAPI XList_SetItemColor(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API void WINAPI XList_SetItemColorSel(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API void WINAPI XList_SetItemColorStay(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API COLORREF WINAPI XList_GetItemColor(HELE hEle);
XC_API COLORREF WINAPI XList_GetItemColorSel(HELE hEle);
XC_API COLORREF WINAPI XList_GetItemColorStay(HELE hEle);
...
XC_API void WINAPI XListView_SetItemColorSel(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API void WINAPI XListView_SetItemBorderColorSel(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API void WINAPI XListView_SetItemColorStay(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API void WINAPI XListView_SetItemBorderColorStay(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API void WINAPI XListView_SetItemColorLeave(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API void WINAPI XListView_SetItemBorderColorLeave(HELE hEle,COLORREF color,BYTE alpha=255);
...
XC_API HWINDOW WINAPI XModalWnd_Create(int nWidth,int nHeight,wchar_t *pTitle,HWND hWndParent,int XCStyle=XC_SY_MODAL_WINDOW);
XC_API HWINDOW WINAPI XModalWnd_CreateEx(DWORD dwExStyle, wchar_t* lpClassName, wchar_t* lpWindowName, DWORD dwStyle, int x, int y, int cx, int cy, HWND hWndParent, int XCStyle=XC_SY_MODAL_WINDOW);  //创建窗口
...
XC_API int  WINAPI XPGrid_AddItem(HELE hEle,const wchar_t *pName,int type,int nParentID=XC_ID_ROOT); //添加项
...
XC_API void WINAPI XRichEdit_EnableKeyTab(HELE hEle, BOOL bEnable);
...
XC_API BOOL  WINAPI XRichEdit_SetData(HELE hEle, void *pData, int iRow, int iColumn);
...
XC_API BOOL WINAPI XRichEdit_IsKeyTab(HELE hEle);
...
XC_API void WINAPI XTree_SetStyle(HELE hEle,int style);
...
XC_API void WINAPI XTree_SetItemColor(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API void WINAPI XTree_SetItemColorSel(HELE hEle,COLORREF color,BYTE alpha=255);
XC_API COLORREF WINAPI XTree_GetItemColor(HELE hEle);
XC_API COLORREF WINAPI XTree_GetItemColorSel(HELE hEle);
...
XC_API HWINDOW WINAPI XWnd_Create(int x, int y, int cx, int cy, const wchar_t *pTitle, HWND hWndParent = NULL, int XCStyle = XC_SY_DEFAULT);
XC_API HWINDOW WINAPI XWnd_CreateEx(DWORD dwExStyle, const wchar_t* lpClassName, const wchar_t* lpWindowName, DWORD dwStyle, int x, int y, int cx, int cy, HWND hWndParent=NULL, int XCStyle=XC_SY_DEFAULT);
...
XC_API BOOL WINAPI XWnd_BindLayoutEle(HWINDOW hWindow,int nFlag, HELE hEle);
XC_API HELE WINAPI XWnd_GetLayoutEle(HWINDOW hWindow,int nFlag);
XC_API void WINAPI XWnd_BindLayoutObject(HWINDOW hWindow,int nFlag,HXCGUI hLayout);
XC_API HXCGUI WINAPI XWnd_GetLayoutObject(HWINDOW hWindow,int nFlag);
XC_API void WINAPI XWnd_SetLayoutBkColor(HWINDOW hWindow,int nFlag,COLORREF color,BYTE alpha=255);
...
XC_API void WINAPI XWnd_SetImage(HWINDOW hWindow, HIMAGE hImage);
XC_API void WINAPI XWnd_SetImageLayout(HWINDOW hWindow, HIMAGE hImage,int nFlag);
XC_API void WINAPI XWnd_SetTransparentFlag(HWINDOW hWindow,int nFlag);  //设置透明窗口
