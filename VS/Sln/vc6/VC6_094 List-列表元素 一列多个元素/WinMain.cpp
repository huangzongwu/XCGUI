...
public:
	...
	{
		//此种方法，修改数据适配器保存的数据
		XAdapterTable_SetItemTextEx(hAdapter,0,L"name",L"修改1");
		XAdapterTable_SetItemTextEx(hAdapter,0,L"name2",L"修改2");
		XAdapterTable_SetItemTextEx(hAdapter,0,L"name3",L"修改3");
