...
private:
	void InitSetting()
	{
 ...
 
		{
			...
			XAdapterTable_AddItemText(hAdapter,L"假");
			XAdapterTable_AddItemText(hAdapter,L"真");
		}
        ...
        XAdapterMap_AddItemText(hAdapterHeader,(XC_NAME),L"选择");
        XAdapterMap_AddItemText(hAdapterHeader,(XC_NAME2),L"有效期");
        XAdapterMap_AddItemText(hAdapterHeader,(XC_NAME3),L"备注");
